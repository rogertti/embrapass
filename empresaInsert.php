    ...
    $msg = "Campo obrigat&oacute;rio vazio.";
        ...
        if($filtro == 1) {
            try {
                ...
                $sql = $pdo->prepare("SELECT idempresa,monitor FROM empresa WHERE nome = :nome");
                ...
                //insere no banco
                $monitor = 'T';
                $sql = $pdo->prepare("INSERT INTO empresa (nome,anotacao,monitor) VALUES (:nome,:anotacao,:monitor)");
                ...
                $res = $sql->execute();
                    ...
                    if(!$res) {
                        ...
                        if($_POST['modalequipamento'] == 'T'){
                            ...
                            $py = md5('idempresa');
                            echo'<url>equipamentoNew.php?'.$py.'='.$idempresa.'</url>';
                        } else {
                            echo'true';
                        }
                    }
