...
/*global $, jQuery, document, window, AdminLTEOptions, _init, FastClick */
    ...
    $.AdminLTE.layout = {
        ...
        fix: function () {
            ...
            var footer_height = $('.main-footer').outerHeight() || 0,
                neg = $('.main-header').outerHeight() + footer_height,
                window_height = $(window).height(),
                sidebar_height = $(".sidebar").height() || 0,
                postSetWidth,
                controlSidebar;
    ...
    */
    $.AdminLTE.tree = function (menu) {
        ...
        $(document).off('click', menu + ' li a').on('click', menu + ' li a', function (e) {
            ...
            var $this = $(this), checkElement = $this.next(), parent, parent_li, ul;
...
(function ($) {
    ...
    $(".table span a, .navbar-nav li a, .input-group-addon a, .timeline-footer span a").tooltip();
    ...
    $("#senha").show(function () {
        $(".a-show-password").click(function (e) {
            e.preventDefault();
            
            $(this).addClass("hide");
            $(".a-hide-password").removeClass("hide");
            $("#senha").attr("type", "text");
        });
        
        $(".a-hide-password").click(function (e) {
            e.preventDefault();
            
            $(this).addClass("hide");
            $(".a-show-password").removeClass("hide");
